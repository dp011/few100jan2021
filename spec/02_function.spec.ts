describe('functions', () => {
    ...
    describe('parameteres and overloading, etc.', () => {
        it('you cannot overload', () => {

            function formatName(first: string, last: string, mi?: string): string { //middle initial is optional '?'
        ...
        it('default values for parameteres', () => {
            // Rest operator...
        ...
        it('side-hike "spread" operator...', () => {
            ...
            // we preper to create new things over modifying things.
    ...
    describe('what', () => {
        // takes one or more functions as arguments (i.e. procedural parameteres)
    ...
    describe('array methods', () => {
        ...
        describe('array methods that retun new arrays', () => {

            it('filtering an arry', () => {
                // where in LINQ
            ...
            describe('a couple of practices', () => {
                ...
                it('try this one on your own', () => {
                    ...
                    // our rule sis a high-mileage vehicle is any vehicle with 50,000 or over.
                    const highMileageVehicles = vehicles // vehicle[...all the vehicles (3)]
                        ...
                        .map(v => `${v.make} ${v.model}`); // string[... make and model of the vehicles]
